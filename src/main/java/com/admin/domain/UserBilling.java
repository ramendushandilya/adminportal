...
public class UserBilling {
    ...
    public String getUserBillingZip() {
        return userBillingZip;
    }

    public void setUserBillingZip(String userBillingZip) {
        this.userBillingZip = userBillingZip;
    }
